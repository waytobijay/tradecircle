...
/**
 * Upload a video file to Cloudinary via unsigned upload preset.
 * Uses resource_type=video so MP4 / WebM / MOV are stored as videos rather
 * than rejected as unsupported images.
 */
